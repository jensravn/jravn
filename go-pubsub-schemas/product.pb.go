...
func (x *Product) GetStartDate() *timestamppb.Timestamp {
	if x != nil {
		return x.StartDate
	}
	return nil
...
func (x *Product) GetEndDate() *timestamppb.Timestamp {
	if x != nil {
		return x.EndDate
	}
	return nil
...
var file_product_proto_depIdxs = []int32{
	1, // 0: Product.startDate:type_name -> google.protobuf.Timestamp
	1, // 1: Product.endDate:type_name -> google.protobuf.Timestamp
